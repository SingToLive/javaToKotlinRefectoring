...
// 테스트 대상이 @Service 계층임으로 @SpringBootTest를 넣어줘야함
@SpringBootTest
class UserServiceTest @Autowired constructor(
    ...
    // UserService.java saveUser test
    @Test
    ...
    @Test
    @DisplayName("대출 기록이 많은 유저의 정상 동작한다")
    fun getUserLoanHistoriesTest2() {
        ...
        userLoanHistoryRepository.saveAll(listOf(
            ...
            UserLoanHistory.fixture(savedUser, "book3", UserLoanStatus.RETUREND)
        ))
        // when
        val results = userService.getUserLoanHistories()
